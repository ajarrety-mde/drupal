...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => getenv('SITE3_DATABASE_NAME'),
      'username' => getenv('SITE3_DATABASE_LOGIN'),
      'password' => getenv('SITE3_DATABASE_PASS'),
      'host'     => getenv('SITE3_DATABASE_HOST'),
      'port'     => getenv('SITE3_DATABASE_PORT'),
      'driver'   => 'mysql',
      'prefix'   => getenv('SITE3_DATABASE_PREFIX'),
    ),
  ),
);
