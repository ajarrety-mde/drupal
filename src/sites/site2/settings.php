...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => getenv('SITE2_DATABASE_NAME'),
      'username' => getenv('SITE2_DATABASE_LOGIN'),
      'password' => getenv('SITE2_DATABASE_PASS'),
      'host'     => getenv('SITE2_DATABASE_HOST'),
      'port'     => getenv('SITE2_DATABASE_PORT'),
      'driver'   => 'mysql',
      'prefix'   => getenv('SITE2_DATABASE_PREFIX'),
    ),
  ),
);
