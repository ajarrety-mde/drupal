...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => getenv('SITE1_DATABASE_NAME'),
      'username' => getenv('SITE1_DATABASE_LOGIN'),
      'password' => getenv('SITE1_DATABASE_PASS'),
      'host'     => getenv('SITE1_DATABASE_HOST'),
      'port'     => getenv('SITE1_DATABASE_PORT'),
      'driver'   => 'mysql',
      'prefix'   => getenv('SITE1_DATABASE_PREFIX'),
    ),
  ),
);
 ...
 *
 */
$drupal_hash_salt = 'XHLmcSYZvflNWVR4cgOYxD4aLPJibOwE9qcNDYtK5No';
